...
#line 14 "JavaGrammar.yy"

	#include <string>
	#include <iostream> 

#line 131 "JavaGrammar.tab.cc"
...
{
       0,   166,   166,   179,   184,   191,   194,   202,   206,   214,
     217,   226,   230,   234,   239,   247,   252,   261,   266,   275,
     278,   282,   291,   294,   302,   306,   310,   314,   318,   322,
     326,   330,   334,   338,   342,   346,   350,   357,   361,   367,
     373,   378,   383,   391,   395,   401,   406,   411,   419,   425,
     435,   449,   463,   474,   482,   489,   492,   499,   502,   509,
     512,   518,   521,   525,   529,   534,   542,   545,   548,   551,
     554,   560,   563,   567,   574,   578,   582,   586,   590,   595,
     602,   605,   608,   611,   614,   620,   624,   627,   630,   633,
     636,   639,   642,   646,   650,   654,   659,   664,   669,   674,
     679,   684,   689,   694,   699,   704,   709,   714,   719,   724,
     729,   734,   739,   744,   752,   757,   762,   767,   772,   777,
     782,   790,   793,   796,   799,   802,   805,   808,   811,   814,
     817,   821,   828,   832,   836,   840,   845,   850,   858,   863,
     873,   877,   881,   885,   891,   897,   900,   905,   909,   913,
     918,   923,   926,   929,   937,   947,   952,   959,   967,   975,
     989,  1005,  1008,  1011,  1017,  1020,  1028,  1033,  1041,  1046,
    1055,  1063,  1066,  1072,  1076,  1084,  1089,  1094,  1099,  1107,
    1111,  1119,  1124,  1132,  1136,  1143,  1147,  1156,  1168,  1186,
    1190,  1199,  1207,  1212,  1220,  1225,  1233,  1238,  1246,  1252,
    1263,  1268
};
#endif
...
#line 1956 "JavaGrammar.tab.cc"
    break;

  case 3:
#line 179 "JavaGrammar.yy"
       {
...
#line 1983 "JavaGrammar.tab.cc"
    break;

  case 6:
#line 194 "JavaGrammar.yy"
                                  {
	(yyval.node) = new Node(ptImportContainer);
	(yyval.node)->attach_child(*(yyvsp[-1].node));
	(yyval.node)->attach_child(*(yyvsp[0].node));
}
#line 1993 "JavaGrammar.tab.cc"
    break;
...
#line 2147 "JavaGrammar.tab.cc"
    break;

  case 23:
#line 294 "JavaGrammar.yy"
                                          {
	(yyval.node) = new Node(ptBasicIdentifier, 0, 0, (yyvsp[-2].stVal));
	(yyval.node)->attach_child(*(yyvsp[0].node));
}
#line 2156 "JavaGrammar.tab.cc"
    break;
...
#line 2633 "JavaGrammar.tab.cc"
  ...
  case 73:
#line 567 "JavaGrammar.yy"
                     {
	(yyval.node) = (yyvsp[-1].node);
	(yyval.node)->attach_child(*(yyvsp[0].node));
}
#line 2642 "JavaGrammar.tab.cc"
    break;

  case 74:
#line 574 "JavaGrammar.yy"
                             {
	(yyval.node) = new Node(ptStatement);
	(yyval.node)->attach_child(*(yyvsp[-1].node));
}
#line 2651 "JavaGrammar.tab.cc"
    break;
...
#line 2770 "JavaGrammar.tab.cc"
    break;

  case 89:
#line 633 "JavaGrammar.yy"
               {
...
#line 3250 "JavaGrammar.tab.cc"
    break;

  case 140:
#line 873 "JavaGrammar.yy"
                        {
	(yyval.node) = new Node(ptDeclaration, 0, 0, (yyvsp[0].stVal));
	(yyval.node)->attach_child(*(yyvsp[-1].node));
}
#line 3259 "JavaGrammar.tab.cc"
    break;

  case 141:
#line 877 "JavaGrammar.yy"
                                                   {
...
#line 3296 "JavaGrammar.tab.cc"
  ...
  case 145:
#line 897 "JavaGrammar.yy"
           {
	(yyval.node) = (yyvsp[0].node);
}
#line 3304 "JavaGrammar.tab.cc"
    break;
...
#line 3314 "JavaGrammar.tab.cc"
    break;

  case 147:
#line 905 "JavaGrammar.yy"
                                {
	(yyval.node) = new Node(ptArrayExplicitInitializer);
	(yyval.node)->attach_child(*(yyvsp[-1].node));
}
#line 3323 "JavaGrammar.tab.cc"
    break;

  case 148:
#line 909 "JavaGrammar.yy"
                                                                           {
	(yyval.node) = new Node(ptArrayExplicitInitializer);
	(yyval.node)->attach_child(*(yyvsp[-1].node));
}
#line 3332 "JavaGrammar.tab.cc"
    break;

  case 149:
#line 913 "JavaGrammar.yy"
                                                       {
	(yyval.node) = new Node(ptInstanceInitializer);
	(yyval.node)->attach_child(*(new Node(TOK_IDENTIFIER, 0, 0, (yyvsp[-3].stVal))));
	(yyval.node)->attach_child(*(yyvsp[-1].node));
}
#line 3342 "JavaGrammar.tab.cc"
    break;
...
#line 3378 "JavaGrammar.tab.cc"
    break;

  case 154:
#line 937 "JavaGrammar.yy"
                                  {
...
#line 3400 "JavaGrammar.tab.cc"
  ...
  case 156:
#line 952 "JavaGrammar.yy"
                                     {
	(yyval.node) = new Node(ptDataStructure);
	(yyval.node)->attach_child(*(new Node(TOK_IDENTIFIER, 0, 0, (yyvsp[-2].stVal))));
}
#line 3409 "JavaGrammar.tab.cc"
    break;
...
#line 3419 "JavaGrammar.tab.cc"
    break;

  case 158:
#line 967 "JavaGrammar.yy"
                                                                                       {
	(yyval.node) = new Node(ptDoWhile);
	(yyval.node)->attach_child(*(yyvsp[-2].node));
	(yyval.node)->attach_child(*(yyvsp[-6].node));
}
#line 3429 "JavaGrammar.tab.cc"
    break;

  case 159:
#line 975 "JavaGrammar.yy"
                                                                                                         {
...
#line 3545 "JavaGrammar.tab.cc"
  ...
  case 170:
#line 1055 "JavaGrammar.yy"
                                                                              {
	(yyval.node) = new Node(ptSwitch);
	(yyval.node)->attach_child(*(yyvsp[-4].node));
	(yyval.node)->attach_child(*(yyvsp[-1].node));
}
#line 3555 "JavaGrammar.tab.cc"
    break;

  case 171:
#line 1063 "JavaGrammar.yy"
            {
	(yyval.node) = (yyvsp[0].node);
}
#line 3563 "JavaGrammar.tab.cc"
    break;
...
#line 3571 "JavaGrammar.tab.cc"
  ...
  case 173:
#line 1072 "JavaGrammar.yy"
           {
	(yyval.node) = new Node(ptSwitchBlock);
	(yyval.node)->attach_child(*(yyvsp[0].node));
}
#line 3580 "JavaGrammar.tab.cc"
    break;

  case 174:
#line 1076 "JavaGrammar.yy"
                        {
	(yyval.node) = new Node(ptSwitchBlock);
	(yyval.node)->attach_child(*(yyvsp[-1].node));
	(yyval.node)->attach_child(*(yyvsp[0].node));
...
#line 3639 "JavaGrammar.tab.cc"
  ...
  case 180:
#line 1111 "JavaGrammar.yy"
                                    {
	(yyval.node) = new Node(ptSwitchBlock);
	(yyval.node)->attach_child(*(yyvsp[-1].node));
	(yyval.node)->attach_child(*(yyvsp[0].node));
}
#line 3649 "JavaGrammar.tab.cc"
    break;

  case 181:
#line 1119 "JavaGrammar.yy"
                                                  {
	(yyval.node) = new Node(ptSwitchState);
	(yyval.node)->attach_child(*(yyvsp[-4].node));
	(yyval.node)->attach_child(*(yyvsp[-1].node));
}
#line 3659 "JavaGrammar.tab.cc"
    break;

  case 182:
#line 1124 "JavaGrammar.yy"
                             {
	(yyval.node) = new Node(ptSwitchState);
	(yyval.node)->attach_child(*(yyvsp[-2].node));
	(yyval.node)->attach_child(*(yyvsp[0].node));
}
#line 3669 "JavaGrammar.tab.cc"
    break;
...
#line 3678 "JavaGrammar.tab.cc"
    break;

  case 184:
#line 1136 "JavaGrammar.yy"
             {
	(yyval.node) = new Node(ptSwitchLabel);
...
#line 3696 "JavaGrammar.tab.cc"
    break;

  case 186:
#line 1147 "JavaGrammar.yy"
                           {
	(yyval.node) = new Node(ptCase);
	(yyval.node)->attach_child(*(yyvsp[-2].node));
	(yyval.node)->attach_child(*(yyvsp[0].node));
}
#line 3706 "JavaGrammar.tab.cc"
    break;
...
#line 3723 "JavaGrammar.tab.cc"
    break;

  case 188:
#line 1168 "JavaGrammar.yy"
                                                                                                                                                                       {
	(yyval.node) = new Node(ptTryCatch);
	Node* _try = new Node(ptTry);
	Node* _exc = new Node(ptExceptionContainer);
...
#line 3743 "JavaGrammar.tab.cc"
    break;

  case 189:
#line 1186 "JavaGrammar.yy"
               {
	(yyval.node) = new Node(ptException);
	(yyval.node)->attach_child(*(new Node(TOK_IDENTIFIER, 0, 0, (yyvsp[0].stVal))));
}
#line 3752 "JavaGrammar.tab.cc"
    break;

  case 190:
#line 1190 "JavaGrammar.yy"
                                        {
	(yyval.node) = new Node(ptException);
	(yyval.node)->attach_child(*(new Node(TOK_IDENTIFIER, 0, 0, (yyvsp[-2].stVal))));
	(yyval.node)->attach_child(*(yyvsp[0].node));
}
#line 3762 "JavaGrammar.tab.cc"
    break;

  case 191:
#line 1199 "JavaGrammar.yy"
                                                                {
	(yyval.node) = new Node(ptThrowState);
	(yyval.node)->attach_child(*(new Node(TOK_IDENTIFIER, 0, 0, (yyvsp[-3].stVal))));
	(yyval.node)->attach_child(*(yyvsp[-1].node));
}
#line 3772 "JavaGrammar.tab.cc"
    break;

  case 192:
#line 1207 "JavaGrammar.yy"
                          {
...
#line 3782 "JavaGrammar.tab.cc"
    break;

  case 193:
#line 1212 "JavaGrammar.yy"
                           {
	(yyval.node) = new Node(ptPostDecrement);
	(yyval.node)->attach_child(*(new Node(TOK_IDENTIFIER, 0, 0, (yyvsp[-1].stVal))));
	(yyval.node)->attach_child(*(new Node(TOK_SUBSUB)));
}
#line 3792 "JavaGrammar.tab.cc"
    break;

  case 194:
#line 1220 "JavaGrammar.yy"
                          {
	(yyval.node) = new Node(ptPreDecrement);
	(yyval.node)->attach_child(*(new Node(TOK_ADDADD)));
	(yyval.node)->attach_child(*(new Node(TOK_IDENTIFIER, 0, 0, (yyvsp[0].stVal))));
}
#line 3802 "JavaGrammar.tab.cc"
    break;

  case 195:
#line 1225 "JavaGrammar.yy"
                           {
	(yyval.node) = new Node(ptPreDecrement);
	(yyval.node)->attach_child(*(new Node(TOK_SUBSUB)));
	(yyval.node)->attach_child(*(new Node(TOK_IDENTIFIER, 0, 0, (yyvsp[0].stVal))));
}
#line 3812 "JavaGrammar.tab.cc"
    break;

  case 196:
#line 1233 "JavaGrammar.yy"
                                  {
	(yyval.node) = new Node(ptInstanceMethodCall);
	(yyval.node)->attach_child(*(yyvsp[-2].node));
	(yyval.node)->attach_child(*(yyvsp[0].node));
}
#line 3822 "JavaGrammar.tab.cc"
    break;

  case 197:
#line 1238 "JavaGrammar.yy"
                                   {
	(yyval.node) = new Node(ptInstanceMethodCall);
	(yyval.node)->attach_child(*(new Node(TOK_IDENTIFIER, 0, 0, (yyvsp[-2].stVal))));
	(yyval.node)->attach_child(*(yyvsp[0].node));
}
#line 3832 "JavaGrammar.tab.cc"
    break;
...
#line 3843 "JavaGrammar.tab.cc"
    break;

  case 199:
#line 1252 "JavaGrammar.yy"
                                                                  {
...
#line 3856 "JavaGrammar.tab.cc"
    break;

  case 200:
#line 1263 "JavaGrammar.yy"
                                      {
	(yyval.node) = new Node(ptFieldReference);
	(yyval.node)->attach_child(*(new Node(TOK_IDENTIFIER, 0, 0, (yyvsp[-2].stVal))));
	(yyval.node)->attach_child(*(new Node(TOK_IDENTIFIER, 0, 0, (yyvsp[0].stVal))));
}
#line 3866 "JavaGrammar.tab.cc"
    break;

  case 201:
#line 1268 "JavaGrammar.yy"
                                                                        {
	(yyval.node) = new Node(ptFieldReference);
	(yyval.node)->attach_child(*(yyvsp[-2].node));
	(yyval.node)->attach_child(*(new Node(TOK_IDENTIFIER, 0, 0, (yyvsp[0].stVal))));
}
#line 3876 "JavaGrammar.tab.cc"
    break;


#line 3880 "JavaGrammar.tab.cc"
